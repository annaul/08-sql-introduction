...
app.post('/articles/insert', function(request, response) {
  ...
  client.connect(function(err) {
    ...
    client.query(
      ...
      VALUES ($1, $2, $3, $4, $5, $6);`, // TODO: Write the SQL query to insert a new record
      [
        request.body.title,
        request.body.author,
...
app.put('/articles/update', function(request, response) {
  ...
  client.connect(function(err) {
    ...
    client.query(
      ...
      SET (title = 'title', author = 'author', "authorUrl" = '"authorUrl"', category = 'category', "publishedOn" = '"publishedOn"', body = 'body')
      WHERE (id = 'id')`),
